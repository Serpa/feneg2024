            ...
            <div className='flex flex-col grow p-5'>
                ...
                <div className='flex flex-row p-5 items-center'>
                    <div className='w-2/4 p-5'>
                        ...
                        <p className='text-xl'>
                            A Feira de Negócios do Brasil Central foi idealizada para ser algo diferente e inovador, focada em negócios e cultura. Por isso, o Sicoob Frutal em parceria com o Sebrae e agora com o Sicoob Itapagipe se uniram mais uma vez para promover o desenvolvimento econômico e social da região.
                        </p>
                        <p className='text-xl'>
                        ...
                        <p className='text-xl'>
                            Agradecemos profundamente a todos que participaram do sucesso das últimas edições da FENEG. E deixamos aqui nosso convite para a FENEG!
                        </p>
                    </div>
                    <div className='w-2/4'>
                        <Image priority={true} src={'/evento.png'} width={800} height={800} alt='Foto abertura evento.' />
                    </div>
                </div>
            </div>
        </>

      ...
      <div className="p-5 flex items-center justify-between">
        <div className="flex w-[70%]">
          <Input
            ...
            value={(table.getColumn("pergunta")?.getFilterValue() as string) ?? ""}
            onChange={(event) =>
          ...
          />
          <Input
            placeholder="Procurar Resposta..."
            value={(table.getColumn("resposta")?.getFilterValue() as string) ?? ""}
            onChange={(event) =>
              table.getColumn("resposta")?.setFilterValue(event.target.value)
            }
            className="mx-5 max-w-sm"
          />
        </div>

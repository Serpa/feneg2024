        ...
        <div className='flex justify-center flex-wrap'>
            ...
            {data &&
                <div className='flex flex-col items-center w-2/4 space-y-2'>
                    <h1 className='text-2xl text-verde-escuro font-bold p-5 pb-0'>Informações</h1>
                    <Button><Link href={data.url_pdf ?? ''} rel="noopener noreferrer" target="_blank"> Apresentação </Link></Button>
                    <img src={data.url_image} alt='Mapa' className='px-16 rounded-2xl' />
                    <video controls autoPlay muted className='px-16'>

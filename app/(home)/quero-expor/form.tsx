    ...
    return (
        <Card className="text-verde-escuro">
            <CardHeader>
                ...
                <CardDescription>Faça o cadastro e se torne um expositor na FENEG.</CardDescription>
            </CardHeader>
            ...
            <CardContent>
                ...
                <div className="flex flex-col justify-center mt-3 gap-2">
                    <Link href={`https://wa.me/553484114909?text=Ol%C3%A1%2C+tenho+interesse+em+participar+como+expositor+na+FENEG+e+gostaria+de+obter+mais+informa%C3%A7%C3%B5es...`} target="_blank" className="w-full">
